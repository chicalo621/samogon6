...
document.getElementById('device_ver').innerText = d.device_version ? 'v' + d.device_version : '';
if (document.getElementById('chip_id')) document.getElementById('chip_id').innerText = d.chip_id || '-';
...
<div class="c">
<h1>🔗 Samogon <span id="device_ver" style="font-size:.9em;color:#ccc"></span></h1>
...
<div class="row"><span class="lbl">Chip ID:</span><span id="chip_id" class="val">---</span></div>
